...
export interface DrugCatalogItem {
  ...
  source: 'local' | 'dinavisa' | 'anvisa' | 'fda' | 'infarmed';
  sourceId?: string;
  country: string;
...
export interface Patient {
  ...
  photo_url?: string;
  preferred_language?: 'es' | 'es-AR' | 'es-PY' | 'gn' | 'pt-BR' | 'pt-PT' | 'en' | 'outros' | '';
}
