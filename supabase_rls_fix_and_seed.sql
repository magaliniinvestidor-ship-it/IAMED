-- ============================================================
-- IAMED - FIX RLS: ADICIONAR POLÍTICAS DE LEITURA PÚBLICA
...
CREATE POLICY "Allow public read clinical_history" ON clinical_history FOR SELECT USING (true);
DROP POLICY IF EXISTS "Allow anon insert clinical_history" ON clinical_history;
CREATE POLICY "Allow anon insert clinical_history" ON clinical_history FOR INSERT WITH CHECK (true);
...
DROP POLICY IF EXISTS "Allow public read financial_postings" ON financial_postings;
CREATE POLICY "Allow public read financial_postings" ON financial_postings FOR SELECT USING (true);
DROP POLICY IF EXISTS "Allow anon insert financial_postings" ON financial_postings;
CREATE POLICY "Allow anon insert financial_postings" ON financial_postings FOR INSERT WITH CHECK (true);
...
DROP POLICY IF EXISTS "Allow anon insert stock_items" ON stock_items;
CREATE POLICY "Allow anon insert stock_items" ON stock_items FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "Allow anon update stock_items" ON stock_items;
CREATE POLICY "Allow anon update stock_items" ON stock_items FOR UPDATE USING (true);

-- beds
ALTER TABLE beds ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "Allow public read beds" ON beds;
CREATE POLICY "Allow public read beds" ON beds FOR SELECT USING (true);
DROP POLICY IF EXISTS "Allow anon update beds" ON beds;
CREATE POLICY "Allow anon update beds" ON beds FOR UPDATE USING (true);
...
-- aso_exams
ALTER TABLE aso_exams ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "Allow public read aso_exams" ON aso_exams;
CREATE POLICY "Allow public read aso_exams" ON aso_exams FOR SELECT USING (true);
DROP POLICY IF EXISTS "Allow anon insert aso_exams" ON aso_exams;
CREATE POLICY "Allow anon insert aso_exams" ON aso_exams FOR INSERT WITH CHECK (true);
...
-- ============================================================
-- RE-SEED: INSERIR DADOS QUE NÃO FORAM ADICIONADOS
-- ============================================================
